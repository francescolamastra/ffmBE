...
(1, 1, 1, 'Squadra 1', 1, CURRENT_TIMESTAMP),
(2, 2, 2, 'Squadra 2', 2, CURRENT_TIMESTAMP);
...
-- Operazione
INSERT INTO operazione (ID, ID_SQUADRA, ID_GIOCATORE, ID_TIPO_OPERAZIONE, ID_STAGIONE, DATA) VALUES
